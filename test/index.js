...
describe('default single strategy', () => {
    ...
    it('return 401 with allowChaining and a single strategy', async () => {

        const request = { method: 'GET', url: '/chain_single_strategy', headers: { authorization: 'Bearer 12345678' } };
...
describe('default chain of strategies', () => {
    ...
    it('return 200 with a chain of strategies', async () => {

        const request = { method: 'GET', url: '/chain', headers: { authorization: 'Bearer 12345678' } };
